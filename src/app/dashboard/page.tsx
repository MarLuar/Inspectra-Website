        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="space-y-3">
              ...
              <Link href="/projects" className="block w-full text-center bg-blue-100 text-blue-800 py-2 rounded-md hover:bg-blue-200">
                Manage Projects
              </Link>
              <Link href="/documents" className="block w-full text-center bg-blue-100 text-blue-800 py-2 rounded-md hover:bg-blue-200">
                View Documents
              </Link>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <ul className="space-y-2">
              <li className="text-sm text-blue-600">Added 3 new blueprints to Project Alpha</li>
              <li className="text-sm text-blue-600">Enhanced image quality for Inspection Report #12</li>
              <li className="text-sm text-blue-600">Generated QR code for Project Beta</li>
            </ul>
          </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="text-center p-4 bg-yellow-50 rounded-lg">
              ...
              <p className="text-blue-600">Scans Today</p>
            </div>
            <div className="text-center p-4 bg-purple-50 rounded-lg">
              <p className="text-3xl font-bold">8</p>
              <p className="text-blue-600">Teams</p>
            </div>
          </div>
        </div>
      </main>
